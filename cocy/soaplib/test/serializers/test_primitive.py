...
from cocy.soaplib.serializers.clazz import Array
from cocy.soaplib.serializers.primitive import Boolean
from cocy.soaplib.serializers.primitive import DateTime
from cocy.soaplib.serializers.primitive import Float
from cocy.soaplib.serializers.primitive import Integer
from cocy.soaplib.serializers.base import Null
from cocy.soaplib.serializers.primitive import String
...
class TestPrimitive(unittest.TestCase):
    ...
    def test_integer(self):
        ...
        self.assertEquals('xs:integer', element.get('{%s}type' % cocy.soaplib.ns_xsi))
    ...
    def test_float(self):
        ...
        self.assertEquals('xs:float', element.get('{%s}type' % cocy.soaplib.ns_xsi))
    ...
    def test_null(self):
        ...
        element = element[0]
        self.assertTrue( bool(element.get('{%s}nil' % cocy.soaplib.ns_xsi)) )
    ...
    def test_boolean(self):
        ...
        Boolean.to_xml(False, ns_test, b)
        b = b[0]
        self.assertEquals('xs:boolean', b.get('{%s}type' % cocy.soaplib.ns_xsi))

        b = etree.Element('test')
        Boolean.to_xml(None, ns_test, b)
        b = b[0]
        self.assertEquals('true', b.get('{%s}nil' % cocy.soaplib.ns_xsi))
